...
class RNNModel:
    ...
    def build_model(self):
        ...
        self.model = Sequential([
            SimpleRNN(64, activation='relu', input_shape=(self.seq_length, self.n_features),
    ...
    def train_and_predict(self, X_train, y_train, X_test):
        """
        Train RNN model and make predictions
...
def train_and_predict_rnn(X_train, y_train, X_test, seq_length=10, n_features=10,
                          epochs=50, verbose=0):
    """
    Utility function for RNN training and prediction
    
    Returns predictions with same length as X_test
    """
    rnn = RNNModel(seq_length, n_features, epochs=epochs, verbose=verbose)
    return rnn.train_and_predict(X_train, y_train, X_test)
